...
namespace FlyElephant.Tests
{
    ...
    public class Tests
    {
        ...
        {
            Assert.IsTrue(new[] {"КОТ"}.SequenceEqual(FindPath("КОТ", "КОТ", dictionary)));
        }

        [TestMethod]
        public void ArgsDifferentLengths()
        {
            Assert.IsNull(FindPath("КОТ", "НОТА", dictionary));
        }

        [TestMethod]
        public void StartWordNotInDictionary()
        {
            Assert.IsNull(FindPath("КОТ", "ТОН", new[] {"ТОН", "НОТА", "КОТЫ", "РОТ", "РОТА", "ТОТ"}));
        }

        [TestMethod]
        public void EndWordNotInDictionary()
        {
            Assert.IsNull(FindPath("КОТ", "ТОН", new[] {"КОТ", "НОТА", "КОТЫ", "РОТ", "РОТА", "ТОТ"}));
        }

        [TestMethod]
        public void StartWordIsEmpty()
        {
            Assert.IsNull(FindPath("", "ТОН", dictionary));
        }

        [TestMethod]
        public void EndWordIsEmpty()
        {
            Assert.IsNull(FindPath("КОТ", "", dictionary));
        }

        [TestMethod]
        public void WordsAreEmpty()
        {
            Assert.IsTrue(new[] {""}.SequenceEqual(FindPath("", "", new[] {""})));
        }
        ...
        {
            Assert.IsTrue(new[] {"КОТ", "ТОТ", "ТОН"}.SequenceEqual(
                FindPath("КОТ", "ТОН", new[] {"КОТ", "ТОН", "НОТА", "КОТЫ", "РОТ", "РОТА", "ТОТ", "ТОТ"})));
        }

        [TestMethod]
        public void EmptyDictionary()
        {
            Assert.IsNull(FindPath("КОТ", "КОТ", new string[] {}));
        }

        [TestMethod]
        public void EmptyDictionary2()
        {
            Assert.IsNull(FindPath("КОТ", "ТОН", new string[] {}));
        }

        [TestMethod]
        public void SingleLetterWords()
        {
            Assert.IsTrue(new[] {"a", "b"}.SequenceEqual(FindPath("a", "b", new[] {"a", "b", "c"})));
        }

        [TestMethod]
        public void SingleLetterWords2()
        {
            Assert.IsNull(FindPath("a", "b", new[] {"c"}));
        }
    }
}
